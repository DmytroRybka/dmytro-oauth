...
public class XoauthSaslClientFactory implements SaslClientFactory {
  ...
  //extensions for 2 legged support:
  /* is either "true" or "false" */
  public static final String OAUTH_TWO_LEGGED_ENABLED =
      "mail.imaps.sasl.mechanisms.xoauth.twoLeggedEnabled";
  
  public static final String OAUTH_TWO_LEGGED_EMAIL =
      "mail.imaps.sasl.mechanisms.xoauth.twoLeggedEmail";
  ...
  public SaslClient createSaslClient(String[] mechanisms,
    ...
    //check if two or standard three legged and return appropriate SaslClient
    String isTwoLegged = (String) props.get(OAUTH_TWO_LEGGED_ENABLED);
    
    if (isTwoLegged.equals("false")) {
        ...
        return new XoauthTwoLeggedSaslClient(
        		xoauthProtocol,
                (String) props.get(CONSUMER_KEY_PROP),
                (String) props.get(CONSUMER_SECRET_PROP),
                (String) props.get(OAUTH_TWO_LEGGED_EMAIL));
    }
